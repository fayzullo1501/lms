					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="subject_overview.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Назад</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
  								  ...
  								  <form class="form-horizontal" method="post">
										...
										<button name="save" type="submit" class="btn btn-info"><i class="icon-save"></i> Сохаринть</button>
										</div>
										</div>
										</form>
