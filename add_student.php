        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="pull-right">
							<a href="my_students.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> Назад</a>
						</div>
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Мои студенты</a><span class="divider">/</span></li>
							<li><a href="#"><b>Добавить студента</b></a></li>
						</ul>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<form method="post" action="">
										...
										<button name="submit" type="submit" class="btn btn-info"><i class="icon-save"></i>&nbsp;Добавить студента</button>
												<br>
												<br>
