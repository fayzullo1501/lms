                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="quiz_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Назад</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
								        <div class="control-group">
											<label class="control-label" for="inputPassword">Вопросы</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Тип вопроса:</label>
											<div class="controls">			
										...
										<div class="control-group">
											...
											<div class="controls">			
													...
													<div id="opt12">
														<input name="correctt" value="True" type="radio">Правильно<br /><br />
														<input name="correctt"  value="False" type="radio">Не правильно<br /><br />
													</div>
											</div>
										</div>
